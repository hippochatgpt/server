...
//                .apiHost("https://自己代理的服务器地址/")
    ...
    public void chat() {
        //聊天模型：gpt-3.5
        Message message = Message.builder().role(Message.Role.USER).content("我现在需要你是一个专业营养师，我现在需要一个月内增重五公斤，你能给我列出我接下来一个月的增重计划么？包括饮食计划，运动计划，我现在的身高体重是178CM,65KG！").build();
